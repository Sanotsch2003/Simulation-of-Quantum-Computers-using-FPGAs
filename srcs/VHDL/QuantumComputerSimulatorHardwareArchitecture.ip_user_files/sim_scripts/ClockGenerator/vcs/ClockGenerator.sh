...
#
# Script generated by Vivado on Sun Mar 17 19:39:35 +0100 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ClockGenerator.sh
...
#
# Usage        : ClockGenerator.sh
#                ClockGenerator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ClockGenerator.sh [-reset_run]
#                ClockGenerator.sh [-reset_log]
#                ClockGenerator.sh [-help]
#
...
#                script (type 'ClockGenerator.sh -help' for more information).
#
...
# script info
echo -e "ClockGenerator.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ClockGenerator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ClockGenerator xil_defaultlib.glbl -o ClockGenerator_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ClockGenerator_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ClockGenerator_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ClockGenerator_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ClockGenerator.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ClockGenerator.sh [-help]\n\
Usage: ClockGenerator.sh [-step]\n\
Usage: ClockGenerator.sh [-lib_map_path]\n\
Usage: ClockGenerator.sh [-reset_run]\n\
Usage: ClockGenerator.sh [-reset_log]\n\
Usage: ClockGenerator.sh [-keep_index]\n\
Usage: ClockGenerator.sh [-noclean_files]\n\n\
